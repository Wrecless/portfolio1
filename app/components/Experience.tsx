...
const experiences = [
    ...
    },
    {
        ...
        description:
            "Assisted in the development of the company's main product, gained experience in agile methodologies and version control.",
    },
]
        ...
        <section id="experience" className="py-20">
            ...
            <div className="space-y-12">
                {experiences.map((exp, index) => (
                    <Parallax key={exp.company} translateY={[`${50 + index * 25}px`, `-${50 + index * 25}px`]}>
                        <motion.div
